      ...
      <div class="container">
        <div class="card">
            ...
            <div class="d-flex justify-content-center">
                <form method="post" action="{{route('update_bnars',$banars->id)}}" enctype="multipart/form-data"
                    class="was-validated">
                    @csrf

                    <div class="mb-3 mt-3 ">
                        <label for="file" class="form-label">upload image banrs</label>
                        <input type="file" class="form-control" id="image" name="image" value="{{$banars->image}}">
